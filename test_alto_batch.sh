...
cp "$ALTO_XML_FILENAME.jp2" "${BATCH_DIR}/${BATCH_NAME}/data/sn00000001/001/${BATCH_DATE}/0001.jp2"
cp "$ALTO_XML_FILENAME.tif" "${BATCH_DIR}/${BATCH_NAME}/data/sn00000001/001/${BATCH_DATE}/0001.tif"
...
docker compose -f "$DOCKER_COMPOSE_PATH" exec -T web bash -c "curl -s http://localhost/lccn/sn00000001/1994-01-12/ed-1/seq-1/"
