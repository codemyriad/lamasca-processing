...
from lp_labelstudio.escriptorium_cli import get_escriptorium_config, get_api_url, escriptorium
...
def create_document(directory, replace_from, replace_to, project_id, name, main_script):
    ...
    try:
        ...
        console.print(f"[red]Error: Failed to create document or upload parts. {str(e)}[/red]")
